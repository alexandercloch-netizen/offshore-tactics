...
// Pure client-side auth helpers live in authValidation.ts (no Supabase import) so
// they can be unit-tested without the provider graph; imported for internal use
// and re-exported for callers that imported them from here.
import { validateCredentials, mapAuthError } from './authValidation';
export { validateCredentials, mapAuthError };

...
export const RACES: Race[] = [
  ...
  },
  {
    ...
    waypoints: [
      ...
      { name: 'Manitou Passage approach 1', lat: 45.145, lon: -86.0717, type: 'turn' },
      ...
      { name: 'Gray\'s Reef Passage', lat: 45.775, lon: -85.5, type: 'mark' },
  ...
  },
  {
    ...
    waypoints: [
      { name: 'Grand Harbour, Valletta', lat: 35.9098, lon: 14.5221, type: 'start' },
      { name: 'Grand Harbour, Valletta approach 1', lat: 36.6764, lon: 15.1554, type: 'turn' },
      { name: 'Capo Passero', lat: 36.6977, lon: 15.138, type: 'turn' },
      { name: 'Capo Passero approach 1', lat: 37.0204, lon: 15.344, type: 'turn' },
      { name: 'Capo Passero approach 2', lat: 38.237, lon: 15.6273, type: 'turn' },
      { name: 'Strait of Messina', lat: 38.2691, lon: 15.6563, type: 'turn' },
      ...
      { name: 'Stromboli approach 3', lat: 37.9487, lon: 12.3568, type: 'turn' },
      { name: 'Stromboli approach 4', lat: 37.9252, lon: 12.375, type: 'turn' },
      { name: 'Stromboli approach 5', lat: 37.9085, lon: 12.35, type: 'turn' },
      { name: 'Stromboli approach 6', lat: 37.9154, lon: 12.3235, type: 'turn' },
      { name: 'Favignana (Egadi Is.)', lat: 37.9152, lon: 12.3233, type: 'island' },
      { name: 'Pantelleria', lat: 36.85, lon: 11.95, type: 'island' },
      { name: 'Pantelleria approach 1', lat: 36.8259, lon: 11.9176, type: 'turn' },
      { name: 'Pantelleria approach 2', lat: 36.8182, lon: 11.9099, type: 'turn' },
      { name: 'Lampedusa', lat: 35.525, lon: 12.61, type: 'island' },
      { name: 'South Comino Channel', lat: 35.985, lon: 14.33, type: 'turn' },
      { name: 'South Comino Channel approach 1', lat: 35.9588, lon: 14.3106, type: 'turn' },
      { name: 'South Comino Channel approach 2', lat: 35.8588, lon: 14.3439, type: 'turn' },
      { name: 'South Comino Channel approach 3', lat: 35.7921, lon: 14.4939, type: 'turn' },
      { name: 'South Comino Channel approach 4', lat: 35.8088, lon: 14.5606, type: 'turn' },
      { name: 'South Comino Channel approach 5', lat: 35.8754, lon: 14.5773, type: 'turn' },
      { name: 'Marsamxett (Finish)', lat: 35.9115, lon: 14.5219, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    ...
    waypoints: [
      ...
      { name: 'St David\'s Lighthouse', lat: 32.365, lon: -64.6397, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    ...
    waypoints: [
      { name: 'Cowes (RYS Line)', lat: 50.7748, lon: -1.2959, type: 'start' },
      { name: 'Cowes approach 1', lat: 50.7616, lon: -1.4101, type: 'turn' },
      { name: 'Cowes approach 2', lat: 50.7464, lon: -1.5236, type: 'turn' },
      { name: 'Cowes approach 3', lat: 50.7131, lon: -1.5569, type: 'turn' },
      { name: 'Cowes approach 4', lat: 50.5797, lon: -2.0403, type: 'turn' },
      { name: 'Portland Bill', lat: 50.51, lon: -2.46, type: 'turn' },
      { name: 'Start Point', lat: 50.2225, lon: -3.6432, type: 'turn' },
      { name: 'The Lizard', lat: 49.9553, lon: -5.1973, type: 'turn' },
      ...
      { name: 'Cap de la Hague', lat: 49.725, lon: -1.94, type: 'turn' },
      { name: 'Cap de la Hague approach 1', lat: 49.7043, lon: -1.6787, type: 'turn' },
      { name: 'Cherbourg (Finish)', lat: 49.6596, lon: -1.6023, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    ...
    waypoints: [
      { name: 'Antigua (English Harbour)', lat: 16.9902, lon: -61.7482, type: 'start' },
      { name: 'Antigua approach 1', lat: 16.9769, lon: -61.7281, type: 'turn' },
      { name: 'Green Island', lat: 17.07, lon: -61.65, type: 'mark' },
      { name: 'Barbuda', lat: 17.55, lon: -61.85, type: 'island' },
      { name: 'Barbuda approach 1', lat: 17.0874, lon: -62.5659, type: 'turn' },
      { name: 'Nevis', lat: 17.1, lon: -62.62, type: 'island' },
      { name: 'Nevis approach 1', lat: 17.3757, lon: -62.8743, type: 'turn' },
      { name: 'St Kitts', lat: 17.405, lon: -62.85, type: 'island' },
      { name: 'St Kitts approach 1', lat: 17.5614, lon: -63.0264, type: 'turn' },
      { name: 'Saba', lat: 17.6488, lon: -63.2328, type: 'island' },
      { name: 'Saba approach 1', lat: 17.9365, lon: -62.8618, type: 'turn' },
      { name: 'St Barthélemy', lat: 17.93, lon: -62.83, type: 'island' },
      ...
      { name: 'Tintamarre approach 4', lat: 15.9384, lon: -61.6916, type: 'turn' },
      ...
      { name: 'Antigua (Finish)', lat: 17.0002, lon: -61.7618, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    ...
    waypoints: [
      { name: 'Sydney Heads', lat: -33.8338, lon: 151.2839, type: 'start' },
      { name: 'Sydney Heads approach 1', lat: -33.921, lon: 151.3124, type: 'turn' },
      { name: 'NSW South Coast', lat: -36.5, lon: 150.3, type: 'turn' },
      { name: 'Bass Strait', lat: -39.5, lon: 149.5, type: 'turn' },
      { name: 'Tasman Island', lat: -43.24, lon: 148, type: 'turn' },
      ...
      { name: 'Iron Pot approach 1', lat: -42.8917, lon: 147.3483, type: 'turn' },
      { name: 'Hobart', lat: -42.885, lon: 147.34, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    ...
    waypoints: [
      ...
      { name: 'Point Fermin approach 1', lat: 33.3074, lon: -118.2926, type: 'turn' },
      ...
      { name: 'Diamond Head (Finish)', lat: 21.2491, lon: -157.8047, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    ...
    waypoints: [
      { name: 'Port Townsend, WA', lat: 48.1117, lon: -122.7453, type: 'start' },
      { name: 'Port Townsend, WA approach 1', lat: 48.1444, lon: -122.7652, type: 'turn' },
      { name: 'Victoria, BC', lat: 48.407, lon: -123.3813, type: 'turn' },
      { name: 'Victoria, BC approach 1', lat: 48.3956, lon: -123.3447, type: 'turn' },
      { name: 'Victoria, BC approach 2', lat: 48.4289, lon: -123.2614, type: 'turn' },
      { name: 'Victoria, BC approach 3', lat: 48.5454, lon: -123.3045, type: 'turn' },
      { name: 'Victoria, BC approach 4', lat: 48.6623, lon: -123.3447, type: 'turn' },
      { name: 'Victoria, BC approach 5', lat: 48.7789, lon: -123.3614, type: 'turn' },
      { name: 'Victoria, BC approach 6', lat: 48.9123, lon: -123.4947, type: 'turn' },
      { name: 'Victoria, BC approach 7', lat: 49.0623, lon: -123.6947, type: 'turn' },
      { name: 'Victoria, BC approach 8', lat: 49.1289, lon: -123.7114, type: 'turn' },
      { name: 'Victoria, BC approach 9', lat: 49.1338, lon: -123.7065, type: 'turn' },
      { name: 'Victoria, BC approach 10', lat: 49.1352, lon: -123.696, type: 'turn' },
      { name: 'Victoria, BC approach 11', lat: 49.1421, lon: -123.6982, type: 'turn' },
      { name: 'Victoria, BC approach 12', lat: 49.1456, lon: -123.6947, type: 'turn' },
      { name: 'Victoria, BC approach 13', lat: 49.7289, lon: -124.3614, type: 'turn' },
      { name: 'Victoria, BC approach 14', lat: 49.9956, lon: -125.1781, type: 'turn' },
      { name: 'Victoria, BC approach 15', lat: 50.1289, lon: -125.3281, type: 'turn' },
      { name: 'Seymour Narrows', lat: 50.14, lon: -125.35, type: 'turn' },
      { name: 'Seymour Narrows approach 1', lat: 50.1594, lon: -125.3456, type: 'turn' },
      { name: 'Seymour Narrows approach 2', lat: 50.3177, lon: -125.4373, type: 'turn' },
      { name: 'Seymour Narrows approach 3', lat: 50.3594, lon: -125.5123, type: 'turn' },
      { name: 'Seymour Narrows approach 4', lat: 50.376, lon: -125.6206, type: 'turn' },
      { name: 'Seymour Narrows approach 5', lat: 50.376, lon: -125.829, type: 'turn' },
      { name: 'Seymour Narrows approach 6', lat: 50.4927, lon: -126.279, type: 'turn' },
      { name: 'Seymour Narrows approach 7', lat: 50.5344, lon: -126.629, type: 'turn' },
      { name: 'Seymour Narrows approach 8', lat: 50.9927, lon: -127.529, type: 'turn' },
      { name: 'Cape Caution', lat: 51.16, lon: -127.79, type: 'turn' },
      { name: 'Cape Caution approach 1', lat: 51.5118, lon: -128.1187, type: 'turn' },
      { name: 'Cape Caution approach 2', lat: 51.8785, lon: -128.2687, type: 'turn' },
      { name: 'Cape Caution approach 3', lat: 52.1118, lon: -128.1354, type: 'turn' },
      { name: 'Bella Bella', lat: 52.1647, lon: -128.1372, type: 'mark' },
      { name: 'Bella Bella approach 1', lat: 52.1968, lon: -128.1346, type: 'turn' },
      ...
      { name: 'Bella Bella approach 4', lat: 53.5635, lon: -130.5679, type: 'turn' },
      { name: 'Bella Bella approach 5', lat: 53.8968, lon: -130.7346, type: 'turn' },
      { name: 'Bella Bella approach 6', lat: 54.1635, lon: -130.6346, type: 'turn' },
      ...
      { name: 'Dixon Entrance approach 3', lat: 55.0142, lon: -131.6358, type: 'turn' },
      { name: 'Dixon Entrance approach 4', lat: 55.2976, lon: -131.6191, type: 'turn' },
      { name: 'Ketchikan, AK', lat: 55.335, lon: -131.65, type: 'finish' },
    ],
    divisions: {

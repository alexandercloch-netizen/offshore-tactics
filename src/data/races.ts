...
export const RACES: Race[] = [
  {
    ...
    waypoints: [
      ...
      { name: 'The Needles', lat: 50.66, lon: -1.59, type: 'turn' },
      { name: "St Catherine's Point", lat: 50.575, lon: -1.3, type: 'turn' },
      { name: 'Bembridge Ledge Buoy', lat: 50.69, lon: -1.07, type: 'mark' },

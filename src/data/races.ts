...
export const RACES: Race[] = [
  ...
  {
    id: 'race-cowes-day1',
    seriesId: 'series-cowes-week',
    name: 'Cowes Week — Day 1: The Bramble Scramble',
    location: 'The Solent, Isle of Wight',
    description:
      'Opening day off the Squadron line: out over the Bramble in a fleet still learning its manners, across to Hill Head and back down the Ryde Middle bank for home.',
    distanceNm: 16,
    difficulty: 'Inshore',
    recordTimeHours: 2,
    corinthianRating: 5,
    hazard: 'tidal_gate',
    hazardWaypoint: 'Bramble Bank',
    prevailingWind: { fromDeg: 225, speedKn: 12 },
    signatureHazard:
      'The Bramble Bank in a crowded fleet — half the Solent\'s tide funnels over four metres of water, and every class wants the same corner of it.',
    season: 'August',
    tide: {
      floodDeg: 90,
      peakRateKn: 0.9,
    ...
    divisions: {
      ...
      pro: { entryFee: 0, prizeMoney: 0, fleetSize: 24, paceTarget: 1.08 },
    },
  },
  {
    id: 'race-cowes-day2',
    seriesId: 'series-cowes-week',
    name: 'Cowes Week — Day 2: West Solent',
    location: 'The Solent, Isle of Wight',
    description:
  ...
  },
  {
    id: 'race-cowes-day3',
    seriesId: 'series-cowes-week',
    name: 'Cowes Week — Day 3: The Eastern Circuit',
    location: 'The Solent, Isle of Wight',
    description:
  ...
  },
  {
    id: 'race-cowes-day4',
    seriesId: 'series-cowes-week',
    name: 'Cowes Week — Day 4: The Squadron Lap',
    location: 'The Solent, Isle of Wight',
    description:
  ...
  },
  {
    id: 'race-cowes-day5',
    seriesId: 'series-cowes-week',
    name: 'Cowes Week — Day 5: The Decider',
    location: 'The Solent, Isle of Wight',
    description:
  ...
  {
    id: 'race-beercan-wk1',
    seriesId: 'series-chicago-beercan',
    name: 'Chicago Beer Can - Week 1: Opening Night',
    location: 'Monroe Harbor, Chicago',
    description:
      'The first Wednesday of the season off the Monroe line: a fleet that has not sailed together since September, half of it learning the boat, all of it bound for the Aft Deck afterwards.',
    distanceNm: 10,
    difficulty: 'Inshore',
    recordTimeHours: 1.6,
    corinthianRating: 5,
    hazard: 'lake_squall',
    hazardWaypoint: 'Four Mile Crib',
    prevailingWind: { fromDeg: 175, speedKn: 8 },
    signatureHazard:
      'A summer squall off the plains: the sky goes green over the Loop and thirty knots arrives before the kite is down.',
    season: 'July',
    waypoints: [
      { name: 'Columbia (Monroe Line) (Start)', lat: 41.8830, lon: -87.5820, type: 'start' },
      { name: 'Oak Street', lat: 41.9243, lon: -87.5919, type: 'mark' },
      { name: 'Four Mile Crib', lat: 41.9028, lon: -87.5044, type: 'mark' },
      { name: 'Columbia (Monroe Line) (Finish)', lat: 41.8830, lon: -87.5820, type: 'finish' },
    ],
    divisions: {
      corinthian: { entryFee: 0, prizeMoney: 0, fleetSize: 30, paceTarget: 1.3 },
      pro: { entryFee: 0, prizeMoney: 0, fleetSize: 30, paceTarget: 1.1 },
    },
  },
  {
    id: 'race-beercan-wk2',
    seriesId: 'series-chicago-beercan',
    name: 'Chicago Beer Can - Week 2: The Crib Run',
    location: 'Monroe Harbor, Chicago',
    description:
      'Out to the Two Mile Crib and up the shore to North Avenue - the leg where the evening breeze decides whether it is staying or going home.',
    distanceNm: 11,
    difficulty: 'Inshore',
    recordTimeHours: 1.7,
    corinthianRating: 5,
    hazard: 'lake_squall',
    hazardWaypoint: 'Two Mile Crib',
    prevailingWind: { fromDeg: 175, speedKn: 8 },
    signatureHazard:
      'A summer squall off the plains: the sky goes green over the Loop and thirty knots arrives before the kite is down.',
    season: 'July',
    waypoints: [
      { name: 'Columbia (Monroe Line) (Start)', lat: 41.8830, lon: -87.5820, type: 'start' },
      { name: 'Two Mile Crib', lat: 41.8698, lon: -87.5292, type: 'mark' },
      { name: 'North Avenue', lat: 41.9407, lon: -87.5952, type: 'mark' },
      { name: 'Columbia (Monroe Line) (Finish)', lat: 41.8830, lon: -87.5820, type: 'finish' },
    ],
    divisions: {
      corinthian: { entryFee: 0, prizeMoney: 0, fleetSize: 30, paceTarget: 1.3 },
  ...
  },
  {
    id: 'race-beercan-wk3',
    seriesId: 'series-chicago-beercan',
    name: 'Chicago Beer Can - Week 3: Museum Campus',
    location: 'Monroe Harbor, Chicago',
    description:
      'South to the Museum Campus, out to the crib, then back past the end of Navy Pier with the skyline going gold behind the fleet.',
    distanceNm: 11,
    difficulty: 'Inshore',
    recordTimeHours: 1.7,
    corinthianRating: 5,
    ...
    waypoints: [
      { name: 'Columbia (Monroe Line) (Start)', lat: 41.8830, lon: -87.5820, type: 'start' },
      { name: 'Museum Campus', lat: 41.8451, lon: -87.5820, type: 'mark' },
      { name: 'Four Mile Crib', lat: 41.9028, lon: -87.5044, type: 'mark' },
      { name: 'Navy Pier East', lat: 41.8979, lon: -87.5705, type: 'mark' },
      { name: 'Columbia (Monroe Line) (Finish)', lat: 41.8830, lon: -87.5820, type: 'finish' },
    ],
    divisions: {
      corinthian: { entryFee: 0, prizeMoney: 0, fleetSize: 30, paceTarget: 1.3 },
  ...
  },
  {
    id: 'race-beercan-wk4',
    seriesId: 'series-chicago-beercan',
    name: 'Chicago Beer Can - Week 4: The South Course',
    location: 'Monroe Harbor, Chicago',
    description:
      'Down the lakefront to 31st Street and back out to the crib: the long southerly leg where the shore band and the offshore pressure part company.',
    distanceNm: 11,
    difficulty: 'Inshore',
    recordTimeHours: 1.7,
    corinthianRating: 5,
    ...
    waypoints: [
      { name: 'Columbia (Monroe Line) (Start)', lat: 41.8830, lon: -87.5820, type: 'start' },
      { name: '31st Street', lat: 41.8088, lon: -87.5820, type: 'mark' },
      { name: 'Two Mile Crib', lat: 41.8698, lon: -87.5292, type: 'mark' },
      { name: 'Columbia (Monroe Line) (Finish)', lat: 41.8830, lon: -87.5820, type: 'finish' },
    ],
    divisions: {
  ...
  },
  {
    id: 'race-beercan-wk5',
    seriesId: 'series-chicago-beercan',
    name: 'Chicago Beer Can - Week 5: North Avenue',
    location: 'Monroe Harbor, Chicago',
    description:
      'Up the beach to North Avenue then hard out to the Four Mile Crib - the most exposed course of the series, and the one the squalls find first.',
    distanceNm: 12,
    difficulty: 'Inshore',
    recordTimeHours: 1.8,
    corinthianRating: 5,
  ...
  },
  {
    id: 'race-beercan-wk6',
    seriesId: 'series-chicago-beercan',
    name: 'Chicago Beer Can - Week 6: The Last Wednesday',
    location: 'Monroe Harbor, Chicago',
    description:
      'The final Wednesday: the whole lakefront in one lap, the series on the line, and the fireworks going up off Navy Pier as the last boats finish.',
    distanceNm: 14,
    difficulty: 'Inshore',
    recordTimeHours: 2.1,
    corinthianRating: 5,

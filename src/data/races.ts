...
export const RACES: Race[] = [
  ...
  },
  {
    ...
    description:
      'The 580-mile circumnavigation of Vancouver Island: threading the rapids of the inside passage, rounding the surf-swept top at Cape Scott, then running the wild Pacific coast home — a race with two entirely different oceans in it.',
    distanceNm: 524,
    difficulty: 'Offshore',
    recordTimeHours: 70,
    corinthianRating: 2,
    ...
    waypoints: [
      ...
      { name: 'Johnstone Strait', lat: 50.48, lon: -126.3, type: 'turn' },
      { name: 'Port Hardy offing', lat: 50.8, lon: -127.65, type: 'turn' },
      { name: 'Cape Scott', lat: 50.82, lon: -128.5, type: 'turn' },
      { name: 'Brooks Peninsula offing', lat: 50.05, lon: -128.1, type: 'turn' },
      { name: 'Estevan Point offing', lat: 49.3, lon: -126.75, type: 'turn' },
      { name: 'Barkley Sound offing', lat: 48.75, lon: -125.4, type: 'turn' },
      { name: 'Race Rocks (Return)', lat: 48.28, lon: -123.54, type: 'turn' },
      { name: 'Nanaimo (Finish)', lat: 49.17, lon: -123.93, type: 'finish' },
    ],
    divisions: {
